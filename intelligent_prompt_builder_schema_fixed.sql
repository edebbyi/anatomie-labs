-- ============================================
-- INTELLIGENT PROMPT BUILDER DATABASE SCHEMA (FIXED FOR POSTGRESQL)
-- ============================================
...
CREATE INDEX IF NOT EXISTS idx_thompson_user_id ON thompson_sampling_params(user_id);
CREATE INDEX IF NOT EXISTS idx_thompson_category ON thompson_sampling_params(category);
CREATE INDEX IF NOT EXISTS idx_thompson_updated ON thompson_sampling_params(updated_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_feedback_user_id ON prompt_feedback(user_id);
CREATE INDEX IF NOT EXISTS idx_feedback_prompt_id ON prompt_feedback(prompt_id);
CREATE INDEX IF NOT EXISTS idx_feedback_created_at ON prompt_feedback(created_at DESC);
...
CREATE OR REPLACE FUNCTION reset_thompson_params(p_user_id UUID)
RETURNS INTEGER AS $$
DECLARE
