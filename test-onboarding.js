 ...
 * Tests the complete Podna onboarding flow programmatically
 */
...
const ZIP_FILE = './anatomie-zip.zip';
...
async function runTest() {
  ...
  log('╔═══════════════════════════════════════════════════════════╗', 'blue');
  log('║   🧪 Podna Onboarding End-to-End Test                    ║', 'blue');
  log('╚═══════════════════════════════════════════════════════════╝', 'blue');
  console.log('');
  ...
  try {
    ...
    logStep('🎨', 'Step 4: Generate Initial Images (8 images)');
    log('Generating 8 images with Stable Diffusion XL (may take 2-3 minutes)...', 'cyan');
    console.log('');
